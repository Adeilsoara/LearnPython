...
salario_antigo = float(input('Digite o seu salário atual R$: '))
reajuste_porcentagem = int(input('Digite o valor do reajuste (%): '))

valor_aumento = (reajuste_porcentagem * salario_antigo)/100
